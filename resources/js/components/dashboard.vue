<template>
  <section
    class="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 flex flex-col items-center justify-center relative overflow-hidden">
    <!-- Background Pattern -->
    ...
    <div class="container mx-auto px-6 relative z-10 flex-1 flex items-center justify-center">
      <div class="text-center">
        ...
        <div class="mb-8 flex justify-center">
          <div class="relative">
            <div class="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 p-1">
              <img
        ...
        <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
          Hi, I'm <span class="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Dika Putra
            Susanto</span>
        </h1>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button
            class="border-2 border-white/20 text-white px-8 py-4 rounded-full font-semibold hover:bg-white/10 transition-all duration-300"
        ...
        <div class="flex justify-center space-x-6 mt-12 mb-5">
          ...
          <a href="https://github.com/DikaSusanto" target="_blank" class="text-gray-400 hover:text-white transition-colors duration-300">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path
