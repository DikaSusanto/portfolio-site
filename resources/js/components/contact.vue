    ...
    <div class="container mx-auto px-6">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid lg:grid-cols-2 gap-12">
          ...
          <div class="space-y-8">
            <div>
              <h3 class="text-2xl font-bold text-gray-900 mb-6">Let's talk about your project</h3>
            ...
            <div class="space-y-6">
              <div class="flex items-center space-x-4 group">
                <div
                  class="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div>
                  ...
                  <p class="text-gray-600">susantodika123@gmail.com</p>
                </div>
              </div>
              ...
              <div class="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <p class="text-gray-600">+62 881 037 901 293</p>
                </div>
              </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
              <div class="flex items-center space-x-3 mb-3">
                ...
                <span class="font-semibold text-gray-900">Quick Response</span>
              </div>
            ...
            <div>
              ...
              <div class="flex space-x-4">
                <a href="https://www.instagram.com/dik.ps?igsh=bTJ1N2g5bzM5aDAw" target="_blank"
                  class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-110 group">
                  <svg class="w-5 h-5 text-gray-600 group-hover:text-pink-600" fill="currentColor" viewBox="0 0 24 24">
                    <path
                ...
                <a href="https://github.com/DikaSusanto" target="_blank"
                  class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-110 group">
                  <svg class="w-5 h-5 text-gray-600 group-hover:text-purple-600" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path
          ...
          <div class="relative">
            ...
            <div class="absolute -bottom-6 -left-6 w-32 h-32 bg-purple-500 rounded-full opacity-10 blur-xl"></div>
            ...
            <div class="relative bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
              ...
              <div v-if="showSuccess" class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                <div class="flex items-center">
                  ...
                  <p class="text-green-800 font-medium">Message sent successfully! I'll get back to you soon.</p>
                </div>
              </div>
            </div>
          </div>
